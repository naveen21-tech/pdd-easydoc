        ...
        <div className="lg:col-span-5 bg-white dark:bg-dark-surface rounded-3xl border border-slate-200 dark:border-dark-border p-6 shadow-sm space-y-6">
          ...
          <form onSubmit={handleGenerate} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={generating}
              className="w-full flex items-center justify-center space-x-2 text-white font-bold py-3.5 px-6 rounded-xl text-sm transition-all shadow-md disabled:opacity-50 bg-gradient-to-r from-purple-700 to-indigo-800 dark:from-brand-purple dark:to-brand-amethyst hover:opacity-95 shadow-purple-600/20"
            >
              {generating ? (
                <>
                  <Loader2 className="w-5 h-5 animate-spin" />
                  <span>Synthesizing Document with StudentDoc AI...</span>
                </>
              ) : (
                <>
              ...
              <div className="space-y-4 text-slate-900 dark:text-white">
                {responseTimeMs && (
                  <div className="text-[11px] font-mono text-slate-500 dark:text-slate-400 pb-2 border-b border-slate-200 dark:border-dark-border flex items-center justify-between">
                    <span className="font-bold flex items-center gap-1.5 text-purple-600 dark:text-brand-lavender">
                      <Sparkles className="w-3.5 h-3.5" />
                      <span>Generated with StudentDoc AI Engine</span>
                    </span>
