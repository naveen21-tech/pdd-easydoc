  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="font-display text-2xl font-bold text-ink">AI Document Studio</h2>
        ...
        {templateName && (
          <div className="inline-flex items-center space-x-2 bg-blue-50 text-brand-700 border border-blue-200 px-3.5 py-1.5 rounded-full text-xs font-semibold">
          ...
          <form onSubmit={handleGenerate} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-600 focus:bg-white transition-all text-ink font-medium"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-600 focus:bg-white transition-all text-ink leading-relaxed"
              />
            </div>
        ...
        <div className="lg:col-span-7 bg-white rounded-2xl border border-border p-6 shadow-card flex flex-col min-h-[550px]">
          <div className="flex items-center justify-between pb-4 border-b border-slate-100 mb-4">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="font-display font-bold text-base text-ink">Generated Document Preview</h3>
            </div>
          ...
          <div className="flex-1 bg-surface rounded-xl border border-border p-6 font-sans text-sm leading-relaxed overflow-y-auto max-h-[500px]">
            {generating ? (
              <div className="h-full flex flex-col items-center justify-center text-center py-20 space-y-4">
                <div className="w-12 h-12 rounded-full bg-blue-100 text-brand-600 flex items-center justify-center animate-pulse">
                  <Sparkles className="w-6 h-6 animate-spin" />
                </div>
                <div>
                  <p className="font-display font-bold text-ink text-base">Processing with {provider.toUpperCase()}...</p>
                  <p className="text-xs text-slate-500">Formatting sections, tables, and executive summary</p>
                </div>
              </div>
            ) : outputContent ? (
              <div className="space-y-4 text-ink">
                {responseTimeMs && (
                  <div className="text-[11px] font-mono text-slate-400 pb-2 border-b border-slate-200 flex items-center justify-between">
              ...
              <div className="h-full flex flex-col items-center justify-center text-center py-20 text-slate-400 space-y-3">
                ...
                <div>
                  <p className="font-semibold text-slate-600 text-sm">No Document Generated Yet</p>
