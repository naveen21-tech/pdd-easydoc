...
Additional User Instructions: ${aiInstruction || 'Improve readability, structure clearly with bold highlights and clean tables.'}`;
  ...
  return (
    ...
    >
      ...
      <header className="bg-slate-900/95 backdrop-blur-md border-b border-slate-800 px-4 py-2 flex items-center justify-between gap-3 sticky top-0 z-40 shadow-sm">
        {/* Left Segment: Document Info & Live Status */}
        <div className="flex items-center space-x-3 flex-1 min-w-0">
          <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-purple-600 to-indigo-700 flex items-center justify-center font-black text-white shrink-0 shadow-md font-display text-sm border border-purple-400/30">
            W
          </div>
          ...
          <div className="flex flex-col flex-1 min-w-0">
            <div className="flex items-center space-x-2 mb-0.5">
              ...
              <select
                ...
                className="bg-purple-950/80 text-purple-300 border border-purple-800/60 rounded-md text-[10px] font-bold px-2 py-0.5 focus:outline-none cursor-pointer"
              >
            ...
            <input
              ...
              className="bg-transparent font-display text-sm sm:text-base font-bold text-white focus:outline-none focus:bg-slate-800/90 px-1.5 py-0.5 rounded-lg border border-transparent focus:border-purple-600/50 w-full truncate transition-all"
            />
          </div>

          {/* Save Status & Auto-page count */}
          <div className="hidden md:flex items-center space-x-2 shrink-0">
            <span className="text-[10px] font-bold px-2.5 py-1 rounded-lg bg-purple-950 text-purple-300 border border-purple-800/50">
              {totalPages} A4 {totalPages === 1 ? 'Page' : 'Pages'}
            </span>

            <div className="flex items-center space-x-1.5 text-xs px-2.5 py-1 rounded-lg bg-slate-800/80 border border-slate-700">
              {saveStatus === 'saving' ? (
                <>
                  <Loader2 className="w-3 h-3 animate-spin text-purple-400" />
                  <span className="text-purple-300 text-[11px] font-medium">Saving...</span>
                </>
              ) : saveStatus === 'saved' ? (
                <>
                  <CheckCircle2 className="w-3 h-3 text-emerald-400" />
                  <span className="text-slate-300 text-[11px] font-medium">Saved</span>
                </>
              ) : (
                <>
                  <span className="w-2 h-2 rounded-full bg-amber-400 animate-pulse" />
                  <span className="text-amber-300 text-[11px] font-medium">Unsaved</span>
                </>
              )}
            </div>
          </div>
        ...
        {/* Center Segment: View Mode Switcher */}
        <div className="bg-slate-950 border border-slate-800 p-1 rounded-xl flex items-center shrink-0 shadow-inner">
          <button
        ...
        <div className="flex items-center space-x-2 shrink-0">
          ...
          <div className="relative">
            <button
              onClick={() => setShowDocToolsMenu(!showDocToolsMenu)}
              ...
              title="Document Tools & Formatting Utilities"
            >
              <FileBadge className="w-3.5 h-3.5 text-purple-400" />
              <span className="hidden md:inline">Doc Tools</span>
              <ChevronDown className="w-3 h-3 text-slate-400" />
            </button>

            {showDocToolsMenu && (
              <div
                className="absolute right-0 top-full mt-2 w-64 bg-slate-900 border border-slate-700 rounded-2xl shadow-2xl p-2 z-50 space-y-1 animate-scale-in"
                onClick={() => setShowDocToolsMenu(false)}
              >
                ...
                <button
                  ...
                  className="w-full text-left px-3 py-2 rounded-xl text-xs font-semibold text-slate-200 hover:bg-slate-800 hover:text-purple-300 flex items-center space-x-2 transition-all"
                >
                ...
                >
                  ...
                  <span>Header, Footer & Page Numbers</span>
                </button>
                ...
                >
                  ...
                  <span>Front Title Cover Page</span>
                </button>
                ...
                >
                  ...
                  <span>Insert Page Break (Ctrl+Enter)</span>
                </button>
                ...
                >
                  ...
                  <span>Configure PDF Page Borders</span>
                </button>
                ...
                <button
                  ...
                  className="w-full text-left px-3 py-2 rounded-xl text-xs font-semibold text-emerald-300 hover:bg-slate-800 flex items-center space-x-2 transition-all border-t border-slate-800/80 pt-2"
                >
                  <Activity className="w-4 h-4 text-emerald-400" />
                  <span>6-Pillar Health Diagnostics</span>
                </button>
              </div>
            )}
          </div>
          ...
          <button
            onClick={() => performSave()}
            className="bg-purple-600 hover:bg-purple-700 text-white font-bold text-xs px-3.5 py-2 rounded-xl transition-all shadow-sm flex items-center space-x-1.5 hover:scale-[1.02]"
          >
